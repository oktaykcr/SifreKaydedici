...
//		----------------------------------------
		...
		imageIconInit(icon,9,"GuncelleDialog.png");
	...
	public AnaPanel(){
		...
		textFieldEkle(panel,ekle_fields,4,198,441,358,34);//açýklama
		textFieldEkle(panel,ekle_fields,3,239,359,274,34);//email tf
		textFieldEkle(panel,ekle_fields,2,291,277,173,34);//þifre tf
		textFieldEkle(panel,ekle_fields,1,291,195,173,34);//id tf
		textFieldEkle(panel,ekle_fields,0,269,113,220,34);//þifre adý tf
		...
		table.setPreferredScrollableViewportSize(new Dimension(700,336));
		...
		table.addMouseListener(new MouseAdapter() {
		    ...
		    public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				if(Menu.menuInfo==3){//ara bölümüne geçince tabloya týklandýðýnda araTable metodu çalýþacak
					araTableTextField();
				}
		...
		//JDBConnection.tabloyaAktar();//database verileri burada jtable a aktarýlýyor
		...
		//GUNCELLE PART
		//Guncelle dialog
		textFieldEkle(dPanel,guncelle_field,0,63,38,167,30);//sifre adý
		textFieldEkle(dPanel,guncelle_field,1,80,111,131,30);//id
		textFieldEkle(dPanel,guncelle_field,2,80,185,131,30);//sifre
		textFieldEkle(dPanel,guncelle_field,3,40,258,208,30);//email
		textFieldEkle(dPanel,guncelle_field,4,9,332,272,30);//acýklama
		imageLabelEkle(dPanel,imgLabel,5,icon,9,0,0,295,373);//Dialog panel bg
		//--------------
		...
		//----------------------------------------------------------------------
		//imageLabelEkle(panel,imgLabel,0,icon,0,0,0,586,453);//anapanel bg
		//geri butonu
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource().equals(buttons[3])){//sil icerik buton
